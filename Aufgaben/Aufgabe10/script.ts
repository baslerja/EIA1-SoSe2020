...
var todos: ToDo[] = [
    {
        todosText: "Lorem", todosChecked: true
    },
    {
        todosText: "Ipsum", todosChecked: false
    },
    {
        todosText: "Dolor", todosChecked: false
    }
]
...
function toggleCheckState(index: number): void {
     ...
     */
    todos[index].todosChecked = !todos[index].todosChecked;
